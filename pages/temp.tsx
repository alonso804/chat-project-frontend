...
const Temp: NextPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Content */}
      <main className="h-[100vh] md:h-[100vh] grid grid-cols-1 lg:grid-cols-8">
        {/* Menu movil */}
        <button
          onClick={toggleMenu}
          ...
          <div>
            ...
            >
              ...
              <div className="w-[15%] relative flex items-center justify-center">
                {/* <img src="https://img.freepik.com/foto-gratis/empresaria-confiada-sonriente-que-presenta-brazos-cruzados_1262-20950.jpg" className="w-10 h-10 object-cover rounded-full" /> */}
            ...
            <a href="#" className="flex w-full gap-2 mb-8">
              {/* Image */}
              <div className="w-[15%] relative flex items-center justify-center">
                {/* <img src="https://img.freepik.com/foto-gratis/retrato-joven-alegre-camisa-blanca_171337-17467.jpg" className="w-10 h-10 object-cover rounded-full" /> */}
              </div>
              {/* Name and Hour */}
              <div className="w-[85%] flex justify-between">
                <div>
            ...
            <a href="#" className="flex w-full gap-2 mb-8">
              {/* Image */}
              <div className="w-[15%] relative flex items-center justify-center">
                {/* <img src="https://img.freepik.com/foto-gratis/hermosa-mujer-mediana-edad-aspecto-amistoso-sonrisa-sincera-que-expresa-gratitud-siente-agradecida-muestra-su-corazon-lleno-amor-manteniendo-manos-pecho-sentimientos-humanos-genuinos-positivos_343059-2870.jpg" className="w-10 h-10 object-cover rounded-full" /> */}
              </div>
              {/* Name and Hour */}
              <div className="w-[85%] flex justify-between">
                <div>
        ...
        <section className="bg-[#1E1F24] col-span-6 p-4 md:p-8 relative">
          {/* Info group */}
